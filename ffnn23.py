    ...
    while True:
        ...
        with conn:
            while True:
                ...
                if not data:
                    break
                received_values_23 = list(map(float, data.split()))
                # received_int = struct.unpack('!i', data)[0]  # Convert bytes to integer
                print("Received CSI values from ORAN:", received_values_23) 
...
# Test unkown input data for each MCS. 
                    ...
                    test_data_23 = received_values_23
...
# Print the predicted output
                    ...
                    response_23 = myvalue_23
                    print ("Response 23 send to xApp:", myvalue_23)  
                    conn.sendall(struct.pack('!i', response_23))   # Send integer as 4 bytes