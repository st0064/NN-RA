    ...
    while True:
        ...
        with conn:
            while True:
                ...
                if not data:
                    break
                received_values_21 = list(map(float, data.split()))
                # received_int = struct.unpack('!i', data)[0]  # Convert bytes to integer
                print("Received CSI values from ORAN:", received_values_21) 
...
# Test unkown input data for each MCS. 
                    ...
                    test_data_21 = received_values_21
...
# Print the predicted output
                    ...
                    response_21 = myvalue_21
                    print ("Response 21 send to xApp:", myvalue_21)  
                    conn.sendall(struct.pack('!i', response_21))   # Send integer as 4 bytes