    ...
    while True:
        ...
        with conn:
            while True:
                ...
                if not data:
                    break
                received_values_22 = list(map(float, data.split()))
                # received_int = struct.unpack('!i', data)[0]  # Convert bytes to integer
                print("Received CSI values from ORAN:", received_values_22) 
...
# Test unkown input data for each MCS. 
                    ...
                    test_data_22 = received_values_22
...
# Print the predicted output
                    ...
                    response_22 = myvalue_22
                    print ("Response 22 send to xApp:", myvalue_22)  
                    conn.sendall(struct.pack('!i', response_22))   # Send integer as 4 bytes